...
LoginDeck stores account metadata locally and delegates passwords to the operating-system credential
...
Ordinary bugs that contain no sensitive information may be reported through GitHub Issues. This
learning project does not promise a fixed response time or long-term support window.

Only the latest published release is considered for security fixes. Unsigned learning builds are
not a substitute for a professionally audited password manager.
